...
%
% ---------------------------------------------------------
% FMINSEARCH_CRY_MASITER: code based on the Matlab FMINSEARCH code.
...
%
%
% $Id: fminsearch_CRY_masiter.m 139 2005-12-20 07:48:18Z merche $
%
...
function [x,fval,exitflag,output] = fminsearch_CRY_masiter(funfcn,x,options,varargin)
...
%   $Revision: 1.1 $  $Date: 2005-12-20 08:48:18 +0100 (mar, 20 dic 2005) $
