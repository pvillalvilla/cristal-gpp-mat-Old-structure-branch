...
if any(strcmp(cnf_L2.retracker_name,'OCOG'))
   ...
   cnf_L2.OCOG_retracker.n2=128; %last zero-padded sample to be used in leading edge estimation
...
if any(strcmp(cnf_L2.retracker_name,'ANALYTICAL') | strcmp(cnf_L2.retracker_name,'SAMOSA'))       
    ...
    %------------------ VERBOSE PARAMETERS-------------------------------------
    %--------------------------------------------------------------------------
    cnf_L2.plot_fits_flag    =   0;              % 0 - not plot; 1 - plot fit results
    ...
    cnf_L2.plot_fits_downsampling =100;
