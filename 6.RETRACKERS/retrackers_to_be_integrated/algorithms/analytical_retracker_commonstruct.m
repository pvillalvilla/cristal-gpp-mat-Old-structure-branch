...
% v1.3 2022/03 JPLZ: reverted data and cnf structures
%% ---------------- Handling input variables ------------------------------
if(nargin<2 || nargin>(4+4*2))
...
[ini_p]=gen_fit_params_commonstruct(data,cnf_p);
...
[nf_p] = gen_nonfit_params_EM_commonstruct(data,cnf_p,chd_p,cst_p); 
