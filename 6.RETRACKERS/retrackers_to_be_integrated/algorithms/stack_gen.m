function stack = stack_gen(cst,  chd, x, l, fit_p, nf_p, cnf_p,func_f0,func_f1)%varargin)
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% Versions control:
% v 1.0 Based on the V9 version defined by Cristina Martin-Puig and updated
...
% v1.1 added cst and chd structs

delta_rb_original=cst.c/(2.0*chd.bw);%sampling spacing in the range dimension with no ZP
