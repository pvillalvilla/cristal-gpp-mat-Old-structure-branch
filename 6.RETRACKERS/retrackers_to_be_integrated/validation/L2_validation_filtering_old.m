...
function [res]=L2_validation_filtering_old(filename_L2_ISD,filename_L2_ESA,path_results_comparison,varargin)
...
p.addParamValue('type_outliers_removal',{'percentiles'},@(x)iscellstr(x));
...
%             ESA_L2_SSH_r1(idx_int_ESA(idx_outliers_ESA_L2_SSH))=NaN;
        ...
        case 'hampel'
            [aux,indx] = hampel(ESA_lat_surf(ESA_indexes_int),ESA_L2_SSH_r1(ESA_indexes_int),hampel_wind,hampel_sigma);
            ESA_L2_SSH_r1(ESA_indexes_int)=aux;
            [aux,indx] = hampel(ESA_lat_surf(ESA_indexes_int),ESA_L2_SSH_r1_nocorr(ESA_indexes_int),hampel_wind,hampel_sigma);
            ESA_L2_SSH_r1(ESA_indexes_int)=aux;            
    end
    ...
    switch type_outliers_removal
        ...
        case 'hampel'
            [aux,indx] = hampel(ESA_lat_surf(ESA_indexes_int),ESA_L2_sigma0_r1(ESA_indexes_int),hampel_wind,hampel_sigma);
            ESA_L2_sigma0_r1(ESA_indexes_int)=aux;
    end
	...
	for i_ret=1:length(retrackers)
		switch char(retrackers(i_ret))
			case {'ANALYTICAL_SWH'}
                switch type_outliers_removal
                    case 'percentiles'
                        ...
                        % function
                        %------------------- SSH ----------------------------------
                        IQR=iqr(ISD_L2_SSH_analytical_SWH_MSSfixed(ISD_indexes_int));
                        percentiles = prctile(ISD_L2_SSH_analytical_SWH_MSSfixed(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
                        idx_outliers_ISD_L2_SSH_analytical_SWH_MSSfixed=idx_outliers_ISD_L2_SSH_analytical_SWH_MSSfixed | (ISD_L2_SSH_analytical_SWH_MSSfixed(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_SSH_analytical_SWH_MSSfixed(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
                        ISD_L2_SSH_analytical_SWH_MSSfixed(idx_int_ISD(idx_outliers_ISD_L2_SSH_analytical_SWH_MSSfixed))=NaN;
                        
                        %----------------- sigma0 ---------------------------------
                        IQR=iqr(ISD_L2_sigma0_analytical_SWH_MSSfixed(ISD_indexes_int));
                        percentiles = prctile(ISD_L2_sigma0_analytical_SWH_MSSfixed(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
                        idx_outliers_ISD_L2_sigma0_analytical_SWH_MSSfixed=idx_outliers_ISD_L2_sigma0_analytical_SWH_MSSfixed | (ISD_L2_sigma0_analytical_SWH_MSSfixed(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_sigma0_analytical_SWH_MSSfixed(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
                        ISD_L2_sigma0_analytical_SWH_MSSfixed(idx_int_ISD(idx_outliers_ISD_L2_sigma0_analytical_SWH_MSSfixed))=NaN;
                        
                        %----------------- SWH ------------------------------------
                        IQR=iqr(ISD_L2_SWH_analytical_SWH_MSSfixed(ISD_indexes_int));
                        percentiles = prctile(ISD_L2_SWH_analytical_SWH_MSSfixed(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
                        idx_outliers_ISD_L2_SWH_analytical_SWH_MSSfixed=idx_outliers_ISD_L2_SWH_analytical_SWH_MSSfixed | (ISD_L2_SWH_analytical_SWH_MSSfixed(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_SWH_analytical_SWH_MSSfixed(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
                        ...
                        IQR=iqr(ISD_L2_COR_analytical_SWH_MSSfixed(ISD_indexes_int));
                        percentiles = prctile(ISD_L2_COR_analytical_SWH_MSSfixed(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
                        idx_outliers_ISD_L2_COR_analytical_SWH_MSSfixed=idx_outliers_ISD_L2_COR_analytical_SWH_MSSfixed | (ISD_L2_COR_analytical_SWH_MSSfixed(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_COR_analytical_SWH_MSSfixed(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
            ...
            case {'ANALYTICAL_MSS'}
                ...
                % function
                %------------------- SSH ----------------------------------
                IQR=iqr(ISD_L2_SSH_analytical_MSS_SWHfixed(ISD_indexes_int));
                percentiles = prctile(ISD_L2_SSH_analytical_MSS_SWHfixed(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
                idx_outliers_ISD_L2_SSH_analytical_MSS_SWHfixed=idx_outliers_ISD_L2_SSH_analytical_MSS_SWHfixed | (ISD_L2_SSH_analytical_MSS_SWHfixed(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_SSH_analytical_MSS_SWHfixed(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
                ISD_L2_SSH_analytical_MSS_SWHfixed(idx_int_ISD(idx_outliers_ISD_L2_SSH_analytical_MSS_SWHfixed))=NaN;
                
                %----------------- sigma0 ---------------------------------
                IQR=iqr(ISD_L2_sigma0_analytical_MSS_SWHfixed(ISD_indexes_int));
                percentiles = prctile(ISD_L2_sigma0_analytical_MSS_SWHfixed(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
                idx_outliers_ISD_L2_sigma0_analytical_MSS_SWHfixed=idx_outliers_ISD_L2_sigma0_analytical_MSS_SWHfixed | (ISD_L2_sigma0_analytical_MSS_SWHfixed(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_sigma0_analytical_MSS_SWHfixed(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
                ISD_L2_sigma0_analytical_MSS_SWHfixed(idx_int_ISD(idx_outliers_ISD_L2_sigma0_analytical_MSS_SWHfixed))=NaN;
                
                
                % ---------- COR: pearson correlation coefficient ---------
                IQR=iqr(ISD_L2_COR_analytical_MSS_SWHfixed(ISD_indexes_int));
                percentiles = prctile(ISD_L2_COR_analytical_MSS_SWHfixed(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
                idx_outliers_ISD_L2_COR_analytical_MSS_SWHfixed=idx_outliers_ISD_L2_COR_analytical_MSS_SWHfixed | (ISD_L2_COR_analytical_MSS_SWHfixed(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_COR_analytical_MSS_SWHfixed(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
			...
			case {'OCOG'}
				%------------------------ SSH  ----------------------------
				IQR=iqr(ISD_L2_SSH_OCOG(ISD_indexes_int));
				percentiles = prctile(ISD_L2_SSH_OCOG(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
				idx_outliers_ISD_L2_SSH_OCOG=idx_outliers_ISD_L2_SSH_OCOG | (ISD_L2_SSH_OCOG(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_SSH_OCOG(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));
				ISD_L2_SSH_OCOG(idx_int_ISD(idx_outliers_ISD_L2_SSH_OCOG))=NaN;
					 
				%-------------------- sigma0 ------------------------------
				IQR=iqr(ISD_L2_sigma0_OCOG(ISD_indexes_int));
				percentiles = prctile(ISD_L2_sigma0_OCOG(ISD_indexes_int),[outlier_percentil_low outlier_percentil_high]);
				idx_outliers_ISD_L2_sigma0_OCOG=idx_outliers_ISD_L2_sigma0_OCOG | (ISD_L2_sigma0_OCOG(ISD_indexes_int)<(percentiles(1)-IQR_times*IQR) | ISD_L2_sigma0_OCOG(ISD_indexes_int)>(percentiles(2)+IQR_times*IQR));            
...
if ~isempty(idx_int_ocog)
    ...
    text_in_textbox=[text_in_textbox,...
        {strcat('Comp. OCOG--> RMSE [m]: ',num2str(res.SSH.OCOG.RMSE_error_L2,'%.4g'),', Mean [m]: ',num2str(res.SSH.OCOG.mean_error_L2,'%.4g'))}];        
end
if ~isempty(idx_int_analytical_SWH_MSSfixed)
    ...
    text_in_textbox=[text_in_textbox,...
        {strcat('Comp. ',title_name_SWH_MSSfixed,' --> RMSE [m]: ',num2str(res.SSH.ANALYTICAL_SWH_MSSfixed.RMSE_error_L2,'%.4g'),', Mean [m]: ',num2str(res.SSH.ANALYTICAL_SWH_MSSfixed.mean_error_L2,'%.4g'))}];    
end
if ~isempty(idx_int_analytical_MSS_SWHfixed)
    ...
    text_in_textbox=[text_in_textbox,...
        {strcat('Comp. ',title_name_MSS_SWHfixed,' --> RMSE [m]: ',num2str(res.SSH.ANALYTICAL_MSS_SWHfixed.RMSE_error_L2,'%.4g'),', Mean [m]: ',num2str(res.SSH.ANALYTICAL_MSS_SWHfixed.mean_error_L2,'%.4g'))}];    
end
...
if ESA_num_surfaces_filtered==ISD_num_surfaces_filtered
    ...
    if ~isempty(idx_int_analytical_SWH_MSSfixed)
		...
		idx_outliers=idx_outliers_ESA_L2_SSH | idx_outliers_ISD_L2_sigma0_analytical_SWH_MSSfixed;
    ...
    if ~isempty(idx_int_analytical_MSS_SWHfixed)
		...
		idx_outliers=idx_outliers_ESA_L2_SSH | idx_outliers_ISD_L2_sigma0_analytical_MSS_SWHfixed;
    ...
    if ~isempty(idx_int_ocog)
		...
		idx_outliers=idx_outliers_ESA_L2_SSH | idx_outliers_ISD_L2_sigma0_OCOG;
...
if ~isempty(idx_int_ocog)
    ...
    legend_text=[legend_text,{'L2-ISD OCOG'}];
    text_in_textbox=[text_in_textbox,...
        {strcat('Comp. OCOG--> RMSE [dB]: ',num2str(res.SIGMA0.OCOG.RMSE_error_L2,'%.4g'),', Mean [dB]: ',num2str(res.SIGMA0.OCOG.mean_error_L2,'%.4g'))}];        
end
if ~isempty(idx_int_analytical_SWH_MSSfixed)
    plot(ISD_lat_surf(ISD_indexes_int),ISD_L2_sigma0_analytical_SWH_MSSfixed(ISD_indexes_int),linestyle_analytical_SWH_MSSfixed);
    legend_text=[legend_text,{strcat('L2-ISD ',title_name_SWH_MSSfixed)}];
    text_in_textbox=[text_in_textbox,...
        {strcat('Comp. ',title_name_SWH_MSSfixed,' --> RMSE [dB]: ',num2str(res.SIGMA0.ANALYTICAL_SWH_MSSfixed.RMSE_error_L2,'%.4g'),', Mean [dB]: ',num2str(res.SIGMA0.ANALYTICAL_SWH_MSSfixed.mean_error_L2,'%.4g'))}];
end
if ~isempty(idx_int_analytical_MSS_SWHfixed)
    plot(ISD_lat_surf(ISD_indexes_int),ISD_L2_sigma0_analytical_MSS_SWHfixed(ISD_indexes_int),linestyle_analytical_MSS_SWHfixed);
    legend_text=[legend_text,{strcat('L2-ISD ',title_name_MSS_SWHfixed)}];
    text_in_textbox=[text_in_textbox,...
        {strcat('Comp. ',title_name_MSS_SWHfixed,' --> RMSE [dB]: ',num2str(res.SIGMA0.ANALYTICAL_MSS_SWHfixed.RMSE_error_L2,'%.4g'),', Mean [dB]: ',num2str(res.SIGMA0.ANALYTICAL_MSS_SWHfixed.mean_error_L2,'%.4g'))}];
end
...
if ~isempty(idx_int_analytical_SWH_MSSfixed)
    fprintf(fid,'$---------------- ANALYTICAL_SWH_MSSfixed RETRACKER -------------------------------------------$\n');
    res.SWH.ANALYTICAL_SWH_MSSfixed.mean_error_fitting=nanmean(ISD_L2_SWH_analytical_SWH_MSSfixed(ISD_indexes_int)-ISD_L2_SWH_analytical_SWH_MSSfixed_smoothed);
    ...
    res.SWH.ANALYTICAL_SWH_MSSfixed.rmse_fitting=sqrt(nanmean((ISD_L2_SWH_analytical_SWH_MSSfixed(ISD_indexes_int)-ISD_L2_SWH_analytical_SWH_MSSfixed_smoothed).^2));
...
if ~isempty(idx_int_analytical_SWH_MSSfixed)
    ...
    legend_text=[legend_text,{strcat('L2-ISD ',title_name_SWH_MSSfixed),strcat('L2-ISD ',title_name_SWH_MSSfixed,' (smoothed)')}];
    text_in_textbox=[text_in_textbox,...
        {strcat('Fitting ',title_name_SWH_MSSfixed,' --> RMSE [m]: ',num2str(res.SWH.ANALYTICAL_SWH_MSSfixed.rmse_fitting,'%.4g'),', Mean [m]: ',num2str(res.SWH.ANALYTICAL_SWH_MSSfixed.mean_error_fitting,'%.4g'))}];
end
legend(legend_text(~cellfun(@isempty,legend_text)));
xlim=get(gca,'xlim');
ylim=get(gca,'ylim');
...
if ~isempty(idx_int_analytical_SWH_MSSfixed)
    ...
    legend_text=[legend_text,{strcat('L2-ISD ',title_name_SWH_MSSfixed),strcat('L2-ISD ',title_name_SWH_MSSfixed,' (smoothed)')}];
    text_in_textbox=[text_in_textbox,...
        {strcat('Fitting ',title_name_SWH_MSSfixed,' --> RMSE [%]: ',num2str(res.COR.ANALYTICAL_SWH_MSSfixed.rmse_fitting,'%.4g'),', Mean [%]: ',num2str(res.COR.ANALYTICAL_SWH_MSSfixed.mean_error_fitting,'%.4g'))}];
end
if ~isempty(idx_int_analytical_MSS_SWHfixed)
    ...
    legend_text=[legend_text,{strcat('L2-ISD ',title_name_MSS_SWHfixed),strcat('L2-ISD ',title_name_MSS_SWHfixed,' (smoothed)')}];
    text_in_textbox=[text_in_textbox,...
        {strcat('Fitting ',title_name_MSS_SWHfixed,' --> RMSE [%]: ',num2str(res.COR.ANALYTICAL_MSS_SWHfixed.rmse_fitting,'%.4g'),', Mean [%]: ',num2str(res.COR.ANALYTICAL_MSS_SWHfixed.mean_error_fitting,'%.4g'))}];
end
legend(legend_text(~cellfun(@isempty,legend_text)));
xlim=get(gca,'xlim');
ylim=get(gca,'ylim');
