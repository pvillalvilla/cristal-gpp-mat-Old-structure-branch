function [requirements_values, requirements_met]= requirements_validation_TPT1(L1B_HR, L1BS, L1B_SL,...
    L1A_ku, chd, cst, cnf)
...
% ka band
wfm_AC_ka = abs(L1B_SL.i_samples_ka.*L1B_SL.iq_scale_factor_ka' + ...
    1i*L1B_SL.q_samples_ka.*L1B_SL.iq_scale_factor_ka')^2;
% 2D Re-sampling of the complex matrix
wfm_AC_interp_ka=interpolsinc_2D(wfm_AC_ka,cnf.FFt.zp_ac_TRP,cnf.FFt.zp_al_TRP);
...
% ka band
% [time_pulse_ka,~,~,~,~,L1A_ka] = ...
%     datation_win_delay_pulse(L1A_ka, cnf, chd, cst);
...
% [~, ~, ~,x_vel_sat_sar_pulse_ka,  y_vel_sat_sar_pulse_ka,  z_vel_sat_sar_pulse_ka,...
%     ~, ~,alt_sar_sat_pulse_ka,~,~, ~, ~] = ...
%     osv_attitude_pulse(L1A_ka, time_pulse_ka, cnf, chd, cst);
...
% Ka band
[requirements_values.range_bias_HR_ka, requirements_met.range_bias_HR_ka] = ...
    range_bias(L1B_HR.tracker_range_calibrated_ka, L1B_HR.slant_range_correction_applied_ka,...
    L1B_HR.power_waveform_ka, L1B_HR.Gap_flag_ka, chd.range_PT_ka,chd.range_bias_HR, chd.left_beams_ka, ...
    chd.right_beams_ka, chd.point_target_idx_a, chd, cst);
...
% Ka band
[requirements_values.datation_bias_HR_ka, requirements_met.datation_bias_HR_ka] = ...
    datation_bias_HR(L1B_HR.tracker_range_calibrated_ka, L1B_HR.slant_range_correction_applied_ka,...
    chd.point_target_idx_ka, chd, cst);
...
% ka band
[requirements_values.datation_bias_SL_ka, requirements_met.datation_bias_SL_ka, pos_max_along_focused_ka] = ...
    datation_bias_SL(wfm_AC_interp_ka, L1B_SL.lat_ka, L1B_SL.lon_ka, x_vel_sat_sar_pulse_ka, ...
    y_vel_sat_sar_pulse_ka, z_vel_sat_sar_pulse_ka, alt_sar_sat_pulse_ka, ...
    cnf, chd, cst);
...
[requirements_values.range_bias_L1BS_ku, requirements_met.range_bias_L1BS_ku] = ...
    ...
    chd.right_beams_ku, chd.point_target_idx_ku, chd, cst);
% ka band
[requirements_values.range_bias_L1BS_ka, requirements_met.range_bias_L1BS_ka] = ...
    range_bias(L1BS.tracker_range_calibrated_ka, L1BS.slant_range_correction_applied_ka, ...
    L1BS.power_waveform_ka, L1BS.Gap_flag_ka, chd.range_PT_ka, chd.range_bias_L1BS, chd.left_beams_ka,...
    chd.right_beams_ka, chd.point_target_idx_ku, chd, cst);
...
% ka band
[requirements_values.range_random_error_ka, requirements_met.range_random_error_ka] = ...
    range_random_error(L1BS.range_ka, chd.point_target_idx_ka, chd.range_random_error, chd.N_central_beams);
...
% ka band
[requirements_values.range_slope_L1BS_ka, requirements_met.range_slope_L1BS_ka] = ...
    range_slope(L1BS.range_ka, L1BS.time_ka, chd.point_target_idx_ka, chd.range_slope, chd.N_central_beams);
...
% ka band
[requirements_values.burst_air_pslr_SL_ka, requirements_met.burst_air_pslr_SL_ka] = ...
    burst_air_PSLR(wfm_AC_interp_ka, pos_max_along_focused_ka, chd);
