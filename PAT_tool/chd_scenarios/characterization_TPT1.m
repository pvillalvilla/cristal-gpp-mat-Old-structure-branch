...
chd.point_target_idx_ka = 163;

chd.right_beams_ku = 50;
chd.left_beams_ku = 50;

chd.right_beams_ka = 50;
chd.left_beams_ka = 50;
...
ecef_coord_ka = lla2ecef([L1B.lat_ka(chd.point_target_idx_ka), L1B.lon_ka(chd.point_target_idx_ka), ...
    L1B.alt_ka(chd.point_target_idx_ka)]);
ecef_x_sat_ka = ecef_coord_ka(1);
ecef_y_sat_ka = ecef_coord_ka(2);
ecef_z_sat_ka = ecef_coord_ka(3);
%% Expected values
...
chd.range_PT_ka = sqrt((chd.ECEF_X - ecef_x_sat_ka)^2 + (chd.ECEF_Y - ecef_y_sat_ka)^2 ...
    + (chd.ECEF_Z - ecef_z_sat_ka)^2);
