...
% Adding chd.tx1_sar + chd.pulse_length/2
time_dumm(i_burst,:) = L1A_buffer(i_burst).time_rx_1st -(L1A_buffer(i_burst).win_delay/2)+((0:chd.N_pulses_burst-1)).*L1A_buffer(i_burst).pri_sar + ...
                            chd.tx1_sar + chd.pulse_length/2; 
%                  time_dumm(i_burst,:) = L1A_buffer(i_burst).time_rx_1st+(-(chd.N_pulses_burst-1)/2:1:(chd.N_pulses_burst-1)/2)*L1A_buffer(i_burst).pri_sar; %
...
% %                                          1*L1A_buffer(i_burst).pri_sar + ...
% %                                          1/chd.brf*(i_burst - 1);  % 
%                  time_dumm2(i_burst,:) =  0*time_first_burst + ...
%                                          (-(chd.N_pulses_burst-1)/2:1:(chd.N_pulses_burst-1)/2)*L1A_buffer(i_burst).pri_sar + ...
%                                          1/chd.brf*(i_burst - 1);  %
